...
function answerQuestion(event) {
    ...
    let context = "Only using references from w3.org, explain your answer in a clear, simple and friendly tone. Structure your answer with semantic HTML that is compliant with the WCAG 2.2 AA guidelines. Remove code from your answer. Use an example. Link to the specific WCAG guideline relevant to the question in a new tab. Add links openining in a new tab to referenced used to the end of the answer. Limit to 175 words.";
